...
| 聚焦到活动通知 | `Super` + `N` | | ◻️ | | ◻️ |
| 锁定屏幕 | `Super` + `L` | `Super` + `L` | ✅ | `Super` + `ALT` + `L` | ✅ |
| 显示概览 | 🚫 (`Super`) | `Super`(系统级)<br />`Super` + `A` | ✅ | `Super` + `A` | ✅ |
| 显示全部应用 | `Super` + `A` | 🚫 | ✅ | ❌ | ❌ |
| 显示通知列表 | `Super` + `V` | 🚫 | ✅ | ❌ | ❌ |
...
| 切换应用窗口 | `Super` + `Tab` | `Alt` + `Tab` | ✅ | `Alt` + `Tab` | ✅ |
| 隐藏所有窗口 | 🚫 | | ◻️ | | ◻️ |
