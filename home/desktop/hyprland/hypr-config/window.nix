...
}:
{
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    windowrule = [
      ...
      "float on, size monitor_w*0.6 monitor_h*0.6, center on, match:class ^(nemo|thunderbird|io.missioncenter.MissionCenter|vlc|cc-switch|clash-verge|gnome-disks|org.gnome.baobab|com.github.tchx84.Flatseal)$"
      # LocalSend
