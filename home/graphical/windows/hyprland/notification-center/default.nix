...
}:
{
  ...
  services.mako = {
    ...
    settings = {
      ...
      background-color = "rgba(30, 30, 46, 0.85)"; # 背景颜色
      width = 300; # 通知宽度
      height = 110; # 通知高度

      text-color = "rgba(205, 214, 244, 0.85)"; # 文本颜色
      progress-color = "over rgba(49, 50, 68, 0.85)"; # 进度条颜色
      ...
      # 边框
      border-color = "rgba(137, 220, 235, 0.85)"; # 边框颜色
      border-size = 2; # 边框宽度
      border-radius = 10; # 边框圆角半径

      "urgency=critical" = {
        border-color = "rgba(250, 179, 135, 0.85)";
        default-timeout = 0;
      };
    };
  };
